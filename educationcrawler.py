...
class EducationCrawler(Crawler):
    ...
    def save(self, url, soup):
        try:
            ...
            if body:
                ...
                self.write('edu/' + str(hash(url)), content.encode('utf-8'))
        except Exception, e:
            print e

if __name__ == '__main__':
    pattern = u'(http://edu.qq.com/a/.*)'
    crawler = EducationCrawler(
        ["http://edu.qq.com/"], encoding='gb18030', depth=20, url_pattern=pattern)
    crawler.crawl()
