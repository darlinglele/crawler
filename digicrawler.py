    ...
    def save(self, url, soup):
        try:
            ...
            if body:
                ...
                content = body.text
                self.write('digi/' + str(hash(url)), content.encode('utf-8'))
        except Exception, e:
            print e

if __name__ == '__main__':
    db = MongoClient().digi.pages
    # db.remove()
    pattern = u'(http://digi.tech.qq.com/a/.*)'
    crawler = DigiCrawler(["http://digi.tech.qq.com/"],
