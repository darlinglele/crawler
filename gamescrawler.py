    ...
    def save(self, url, soup):
        try:
            ...
            if body:
                ...
                content = body.text
                self.write('games/' + str(hash(url)), content.encode('utf-8'))
        except Exception, e:
            print e

if __name__ == '__main__':    
    pattern = u'(http://games.qq.com/a/.*)'
    crawler = GamesCrawler(
        ["http://games.qq.com/"], encoding='gb18030', depth=20, url_pattern=pattern)
    crawler.crawl()
