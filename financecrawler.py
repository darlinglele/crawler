    ...
    def save(self, url, soup):
        try:
            ...
            if body:
                ...
                content = body.text
                self.write('finance/' + str(hash(url)), content.encode('utf-8'))
        except Exception, e:
            print e

if __name__ == '__main__':    
    pattern = u'(http://finance.qq.com/a/.*)'
    crawler = FinanceCrawler(["http://finance.qq.com/a/20140627/030910.htm"],
